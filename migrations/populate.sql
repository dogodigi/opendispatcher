...
-- NFPA 170 for USA standards
insert into dbk.type_brandweervoorziening (gid, naam, name_en, name_es, brandweervoorziening_symbool,namespace,categorie,radius,omschrijving) values    
