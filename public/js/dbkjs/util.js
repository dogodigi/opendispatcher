...
/**
 * @namespace dbkjs.argParser
 */
dbkjs.argParser =
  OpenLayers.Class(OpenLayers.Control.ArgParser, {
    /**
     * Initialize the map based upon arguments given with a querystring
     * @memberof dbkjs.argParser
    ...
    /**
     * Configure the layers based upon the parameters given in the querystring
     * @memberof dbkjs.argParser
     */
...
dbkjs.Permalink =
  OpenLayers.Class(OpenLayers.Control.Permalink, {
    ...
    /**
     * @memberof dbkjs.Permalink
     * @param {Object} options - Options to apply to the permalink
     */
    initialize: function(options) {
      OpenLayers.Control.Permalink.prototype.initialize.apply(this, arguments);
    },
    /**
     * The permalink is updated on every map event
     * @memberof dbkjs.Permalink
     */
    updateLink: function() {
    ...
    /**
     * Create the parameters for the permalink
     * @memberof dbkjs.Permalink
     */
...
dbkjs.util = {
   ...
   * @param {Object} obj - the <OpenLayers.Layer> to toggle
   */
   ...
   * @param {String} variable - the parameter to fetch
   * @param {String} [defaultvalue=undefined] - pass a default for when
   * the parameter is not found or returns no value
   * @returns {String} value - the value for the given parameter
   */
   ...
   * @param {Object} olGeom - OpenLayers Geometry
   * @returns {Object} wktGeom - WKT Geometry
   */
   ...
   * @param {Object} jstsGeom - WKT Geometry
   * @returns {Object} olGeom - OpenLayers geom
   */
   ...
   * @param {Object} vLayer - OpenLayers Layer to grab from
   * @param {Object} buffer - the buffer that should be applied
   * @returns {Collection} features - OpenLayers features
   */
   ...
   * @param {Object} vLayer - OpenLayers Layer to grab from
   * @param {Object} jstsLine - the line
   * @param {integer} bufdist - The distance that will be used to buffer the line
   * @returns {Collection} features - OpenLayers features
   */
