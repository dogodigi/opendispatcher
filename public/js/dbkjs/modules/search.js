...
/**
 * Update the filter for active modules
  ...
  pulsate: function(feature) {
    ...
    var resize = function() {
      if (count > 16) {
        ...
        _obj.layer.removeFeatures(feature, {
          silent: true
        });
  ...
  activateFullscreen: function() {
    var _obj = dbkjs.modules.search,
      ...
      dropdownConfig = {
        's_adres': {
          'icon': 'fa fa-home',
          'text': i18n.t("search.address"),
          'placeholder': i18n.t("search.addressplaceholder"),
          'search': 'address'
        },
        's_coord': {
          'icon': 'fa fa-thumb-tack',
          'text': i18n.t("search.coordinates"),
          'placeholder': i18n.t("search.coordplaceholder"),
          'search': 'coordinates'
        },
        's_dbk': {
          'icon': 'fa fa-building',
          'text': i18n.t("search.dbk"),
          'placeholder': i18n.t("search.dbkplaceholder"),
          'search': 'dbk'
        },
        's_oms': {
          'icon': 'fa fa-bell',
          'text': i18n.t("search.oms"),
          'placeholder': i18n.t("search.omsplaceholder"),
          'search': 'oms'
        }
      };
