...
dbkjs.modules.support = {
  ...
  register: function() {
    ...
    var markerStyle = {
      externalGraphic: 'images/supportmarker.png',
      graphicHeight: 32,
      graphicWidth: 32,
      graphicXOffset: -16,
      graphicYOffset: -32
      ...
      $('#foutknop').click(function() {
        ...
        $("#support-form").bind('submit', function(e) {
          ...
          if (!isValid) {
            ...
            var url = (dbkjs.options.urls && dbkjs.options.urls.annotation ? dbkjs.options.urls.annotation : dbkjs.basePath + 'api/annotation/');
            jQuery.ajax({
              type: "POST",
              url: url,
              dataType: "json",
