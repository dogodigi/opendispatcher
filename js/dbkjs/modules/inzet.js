...
dbkjs.modules.inzet = {
    ...
    namespace: "zeeland",
    /**
     * Laag. Wordt geiniteerd met de functie inzet.show() kan worden overruled
     */
    layer: null,
    highlightlayer: null,
    /**
    ...
    register: function(options) {
        ...
        _obj.layer = new OpenLayers.Layer.WMS(
            "Inzet", 
            _obj.url + 'wms', {
                layers: this.namespace + ':WMS_Brandcompartiment,'+ this.namespace + ':WMS_GevaarlijkeStof', 
                format: 'image/png', 
                transparent: true
            }, {
        ...
        dv_panel_content.append('<div class="panel-body">' +
                '<div class="row"><div class="col-xs-6"><img src="' + _obj.url + 'wms?REQUEST=GetLegendGraphic&VERSION=1.0.0&FORMAT=image/png&WIDTH=20&HEIGHT=20&STRICT=false&style=GevaarlijkeStof&legend_options=fontAntiAliasing:true;fontSize:14;dpi:90' + '"></img></div><div class="col-xs-6">Informatie over de preparatieve voorzieningen en de <strong>NEN1414</strong> symbolen vind je op een aparte <a href="nen1414.html#bouwkundige_kenmerken" target="_blank">pagina</a>' +
        '</div></div></div>');
