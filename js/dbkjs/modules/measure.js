...
dbkjs.modules.measure = {
    ...
    register: function() {
        ...
        $('#btngrp_3').append('<a id="btn_measure_distance" class="btn btn-default navbar-btn" href="#" title="Meet afstand"><i class="icon-resize-horizontal rotate_45"></i></a>');
        $('#btngrp_3').append('<a id="btn_measure_area" class="btn btn-default navbar-btn" href="#" title="Meet oppervlakte"><i class="icon-bookmark-empty rotate_45"></i></a>');
