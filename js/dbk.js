...
function procesWFS(response) {
    ...
    if (xmldoc["wfs:FeatureCollection"]["wfs:member"]) {
        if (xmldoc["wfs:FeatureCollection"]["wfs:member"]["dbk:DBKFeature"]) {
            current_dbk_feature.div = $('<div class="tabbable"></div>');
            ...
            if(xmldoc["wfs:FeatureCollection"]["wfs:member"]["dbk:DBKFeature"]["dbk:controleDatum"]){
            ...
            if (foto) {
                ...
                var image_carousel = $('<div id="carousel_foto_' + dbk + '" class="carousel slide" data-interval="false"></div>');
                ...
                if (foto["dbk:Foto"]) {
                    ...
                    $.each(foto, function(foto_index, waarde) {
                        ...
                        image_carousel_nav.append('<li data-target="#carousel_foto_' + dbk + '" data-slide-to="'+ foto_index +'" class="' + active + '"></li>');
                    });
                    image_carousel.append(image_carousel_nav);
                    image_carousel.append(image_carousel_inner);
                    image_carousel.append('<a class="left carousel-control" href="#carousel_foto_' + dbk + '" data-slide="prev">' +
                            '<span class="icon-prev"></span></a>');
                    image_carousel.append('<a class="right carousel-control" href="#carousel_foto_' + dbk + '" data-slide="next">' +
